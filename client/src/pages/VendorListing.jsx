            ...
            >
              <div className="h-48 md:h-64 overflow-hidden relative">
                ...
                <button
                  ...
                  className="absolute top-4 left-4 p-2 bg-black/40 backdrop-blur-md rounded-full text-white hover:text-rose-400 transition-colors"
                >
                  <Heart className={`w-4 h-4 ${savedVendors.includes(vendor.id) ? 'fill-rose-400 text-rose-400' : ''}`} />
                </button>
              </div>
